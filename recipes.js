...
function createTagHTML(recipeTitles) {
  ...
  const html = `
    ...
    <body>
    <div class="container">
    <header class="header3" style="display: flex;">
    <div style="flex: 1;"><p><span class="icon"><a href="index.html"><img src="apple-touch-icon.png"></a> Címkék</span></p></div><div><a style="flex: 1; font-size: 8vw; padding-right: 2vw;" href="randomfoetel.html">🍽️</a></div>
    </header>
      <div class="content">
      <div class="jump">
      ${jump}
